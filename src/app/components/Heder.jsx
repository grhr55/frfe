...
const fetchReactions = async (productId) => {
  ...
  <Tovar   products={products}   handleLike={handleLike} setReactions={setReactions}  sendDeviceReaction={sendDeviceReaction} fetchReactions={fetchReactions} handleDislike={handleDislike} reactions={reactions}/>
