...
const fetchReactions = async (productId) => {
  ...
  return (
    <motion.div className=" h-[100vh] flex flex-col items-center justify-center text-center text-white p-4 overflow-hidden relative" animate={controls}>
      ...
      {!vid && (
        <motion.div className=" flex justify-center" initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
